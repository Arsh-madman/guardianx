    ...
    setTimeout(async () => {
      ...
      if (req.capability === 'LOCATION') {
        ...
        resultData = {
          ...
          longitude: newLng,
          accuracy: 4.2,
          provider: 'fused_location_provider',
        ...
        {deviceLockState === 'LOCKED' ? (
          ...
          <div className="space-y-0">
            ...
            <div className="p-5 space-y-4">
              ...
              {/* GPS LOCATION SIMULATOR FOR TESTING */}
              <div className="p-3.5 rounded-2xl bg-[#08110F] border border-[#214235] space-y-2.5 text-xs">
                <div className="flex items-center justify-between font-bold text-white">
                  <span className="flex items-center gap-1.5">
                    <Navigation className="w-3.5 h-3.5 text-[#62D8C2]" />
                    GPS Presets
                  </span>
                  <span className="text-[10px] text-[#7C9B8A]">Test Coordinates</span>
                </div>

                <div className="grid grid-cols-3 gap-1.5">
                  <button
                    onClick={() => {
                      setSimulatedLat(28.6139);
                      setSimulatedLng(77.2090);
                    }}
                    className="py-1.5 px-2 rounded-lg bg-[#162B24] hover:bg-[#1E3A31] border border-[#2C5142] text-[10px] text-white font-semibold text-center cursor-pointer"
                  >
                    🏠 Home
                  </button>
                  <button
                    onClick={() => {
                      setSimulatedLat(28.6195);
                      setSimulatedLng(77.2185);
                    }}
                    className="py-1.5 px-2 rounded-lg bg-[#162B24] hover:bg-[#1E3A31] border border-[#2C5142] text-[10px] text-white font-semibold text-center cursor-pointer"
                  >
                    🏫 School
                  ...
                  <button
                    onClick={() => {
                      setSimulatedLat(28.6280);
                      setSimulatedLng(77.2280);
                    }}
                    className="py-1.5 px-2 rounded-lg bg-[#162B24] hover:bg-[#1E3A31] border border-[#2C5142] text-[10px] text-white font-semibold text-center cursor-pointer"
                  >
                    🌳 Park
